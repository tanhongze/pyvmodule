...
class TestVerilog(unittest.TestCase):
    ...
    def test_module_decoder_32_extend1(self):
        class DecoderI(VModule):
            di = Wire(5,io='input')
        class Decoder(DecoderI):
            do = decode(di)
            do.io = 'output'
        self.module_case(Decoder,decoder_32_code)
    def test_module_decoder_32_extend2(self):
        class DecoderI(VModule):pass
        DecoderI.di = Wire(5,io='input')
        class Decoder(DecoderI):
            do = decode(di)
            do.io = 'output'
        self.module_case(Decoder,decoder_32_code)
    ...
    def test_module_instance1(self):
        class Decoder(VModule):
            di = Wire(5,io='input')
            do = decode(di)
            do.io = 'output'
    ...
    def test_module_instance2(self):
        class Decoder(VModule):
            di = Wire(5,io='input')
            do = decode(di)
            do.io = 'output'
